...
public class SitecoreRewriteFixture
{
    ...
    [InlineData("path/(.*)", "http://ho?st.com/pÂthBase/path?parãm=$1", RedirectType.REDIRECT_301, true, "http://example.com/pathBase", "path/value?päram1=OtherValüe", "http://xn--host-cpd.com/p%C3%82thBase/path?p%C3%A4ram1=OtherVal%C3%BCe&parãm=value")]
