...
public class ForwardHeadersToLayoutServiceFixture : IClassFixture<TestWebApplicationFactory<TestPagesProgram>>
{
    ...
    public ForwardHeadersToLayoutServiceFixture(TestWebApplicationFactory<TestPagesProgram> factory)
    {
        _factory = factory;
