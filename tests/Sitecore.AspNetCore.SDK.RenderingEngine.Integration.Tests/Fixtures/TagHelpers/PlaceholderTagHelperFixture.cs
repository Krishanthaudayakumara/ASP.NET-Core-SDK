...
public class PlaceholderTagHelperFixture : IDisposable
{
    ...
    public async Task PageInNormalMode_WithNestedPlaceholderComponent_ComponentIsRenderedCorrectly()
    {
        ...
        // Assert
        response.ShouldContain(TestConstants.RichTextFieldValue1);
    }
    ...
    public async Task PageInEditableMode_WithComponentsAndChromes_ComponentAndChromesAreRenderedCorrectly()
    {
        ...
        response.ShouldContain("<code type='text/sitecore' chrometype='rendering' kind='close' id='scEnclosingTag_r_' hintkey='Component 2' class='scpm'></code>");
        response.ShouldContain("<code type='text/sitecore' chrometype='rendering' kind='close' id='scEnclosingTag_r_' hintkey='Component 1' class='scpm'></code>");
        response.ShouldContain("<code type='text/sitecore' chrometype='placeholder' kind='close' id='scEnclosingTag_' hintname='Placeholder-2' class='scpm'></code>");
        response.ShouldContain("<code type='text/sitecore' chrometype='placeholder' kind='close' id='scEnclosingTag_' hintname='Placeholder-1' class='scpm'></code>");
    }
